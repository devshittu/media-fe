...
import {
  AppLogoIcon,
} from '@/components/illustrations';import Hero from '@/components/labs/public-page/hero';
...
const footerCategories = [
  ...
  const articles = [
    ...
    {
      imageUrl: 'https://flowbite.s3.amazonaws.com/blocks/marketing-ui/article/blog-2.png',
    ...
    {
      imageUrl: 'https://flowbite.s3.amazonaws.com/blocks/marketing-ui/article/blog-3.png',
    ...
    {
      imageUrl: 'https://flowbite.s3.amazonaws.com/blocks/marketing-ui/article/blog-4.png',
    ...
    <>
      ...
      <Hero title='Frequently Asked Question'  breadcrumbTrail={breadcrumbTrail} subtitle='Cupiditate minima voluptate temporibus quia? Architecto beatae esse ab
...
<Newsletter heading='Sign up for our newsletter' description='Stay up to date with the roadmap progress, announcements and
              exclusive discounts feel free to sign up with your email.' buttonText='Subscribe to news' />
