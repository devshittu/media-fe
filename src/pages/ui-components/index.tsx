  ...
  return (
    <>
      ...
      <main>
        ...
        <div className="max-w-2xl mx-auto bg-white p-16">
          <form>
            ...
            <div className="flex items-start mb-6">
              ...
              <label
                htmlFor="remember"
                className="ml-2 text-sm font-medium text-slate-900 dark:text-slate-400"
              >
                I agree with the{' '}
                <Link
                  href="/"
        ...
        <button
          type="button"
          className="text-white bg-slate-800 hover:bg-slate-900 focus:outline-none focus:ring-4 focus:ring-slate-300 font-medium rounded-full text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-slate-800 dark:hover:bg-slate-700 dark:focus:ring-slate-700 dark:border-slate-700"
        >
          Dark
        </button>
        <button
          type="button"
          className="text-slate-900 bg-white border border-slate-300 focus:outline-none hover:bg-slate-100 focus:ring-4 focus:ring-slate-200 font-medium rounded-full text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-slate-800 dark:text-white dark:border-slate-600 dark:hover:bg-slate-700 dark:hover:border-slate-600 dark:focus:ring-slate-700"
        >
          Light
        </button>
        <button
