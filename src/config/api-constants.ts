...
export const URI_AUTH_VERIFY_ACCOUNT_BY_TOKEN = "/auth/verify-account/{{token}}/";
export const URI_AUTH_RESEND_VERIFICATION_LINK = "/auth/resend-verification-link/";
...
export const URI_STORIES_CATEGORY_BY_CATEGORY_SLUG = "/stories/category/{{category_slug}}/";
export const URI_USER_FEED = "/user-feed/";
export const URI_STORIES_HASHTAG_BY_HASHTAG_NAME = "/stories/hashtag/{{hashtag_name}}/";
export const URI_STORIES_TRENDING = "/stories/trending/";
export const URI_STORYLINES_BY_STORYLINE_ID_HASHTAGS = "/storylines/{{storyline_id}}/hashtags/";
...
export const URI_STORIES_BY_STORY_SLUG_DISLIKE = "/stories/{{story_slug}}/dislike/";
export const URI_STORIES_BY_STORY_SLUG_UNLIKE = "/stories/{{story_slug}}/unlike/";
export const URI_STORIES_BY_STORY_SLUG_UNDISLIKE = "/stories/{{story_slug}}/undislike/";
...
export const URI_STORIES_BY_STORY_ID_UNDISLIKE = "/stories/{{story_id}}/undislike/";
...
export const URI_STORYLINES_BY_STORYLINE_ID_STORIES = "/storylines/{{storyline_id}}/stories/";
...
export const URI_ANALYTICS_INTERACTIONS_BY_PK = "/analytics/interactions/{{pk}}/";
export const URI_ANALYTICS_INTERACTIONS_BATCH = "/analytics/interactions/batch/";
...
export const URI_ANALYTICS_NOT_INTERESTED_BY_PK = "/analytics/not-interested/{{pk}}/";
export const URI_ANALYTICS_ACCESSIBILITY_TOOLS = "/analytics/accessibility-tools/";
export const URI_ANALYTICS_ACCESSIBILITY_TOOLS_BY_PK = "/analytics/accessibility-tools/{{pk}}/";
...
export const URI_SUPPORT_TICKET_RESPONSES_BY_PK = "/support/ticket-responses/{{pk}}/";
...
export const URI_SUPPORT_BY_VERSION_ARTICLES_CATEGORY_BY_CATEGORY_SLUG = "/support/{{version}}/articles/category/{{category_slug}}/";
export const URI_SUPPORT_BY_VERSION_ARTICLES_BY_PK = "/support/{{version}}/articles/{{pk}}/";
export const URI_SUPPORT_BY_VERSION_ARTICLES_BY_SLUG = "/support/{{version}}/articles/{{slug}}/";
export const URI_SUPPORT_BY_VERSION_FAQS = "/support/{{version}}/faqs/";
export const URI_SUPPORT_BY_VERSION_FAQS_BY_PK = "/support/{{version}}/faqs/{{pk}}/";
export const URI_SUPPORT_BY_VERSION_PRIVACY_POLICIES = "/support/{{version}}/privacy-policies/";
export const URI_SUPPORT_BY_VERSION_TERMS_AND_CONDITIONS = "/support/{{version}}/terms-and-conditions/";
