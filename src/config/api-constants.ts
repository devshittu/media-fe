...
export const URI_SETTINGS = '/settings/';
export const URI_UPDATE_FEED_POSITION = '/update-feed-position/';
export const URI_FOLLOW_BY_USER_ID = '/follow/{{user_id}}/';
export const URI_FOLLOW_BY_USERNAME = '/follow/{{username}}/';
export const URI_UNFOLLOW_BY_USER_ID = '/unfollow/{{user_id}}/';
export const URI_UNFOLLOW_BY_USERNAME = '/unfollow/{{username}}/';
export const URI_BY_USER_ID_FOLLOWERS = '/{{user_id}}/followers/';
